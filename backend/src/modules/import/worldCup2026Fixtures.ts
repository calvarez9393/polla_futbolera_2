...
export type Wc2026GroupLetter = "A" | "B" | "C" | "D" | "E" | "F" | "G" | "H" | "I" | "J" | "K" | "L";

/** Equipos por grupo (orden FIFA en tabla de clasificación) */
export const WC2026_GROUPS: Record<Wc2026GroupLetter, readonly string[]> = {
...
export function fixtureKickoffUtc(f: Wc2026Fixture): string {
  const tz = CITY_TZ[f.city];
  if (!tz) throw new Error(`Zona horaria no definida para ${f.city}`);
...
export const WC2026_GROUP_FIXTURES: Wc2026Fixture[] = [
