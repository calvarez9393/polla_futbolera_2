...
export interface R32FixtureRaw {
  num: number;
  dateLocal: string;
  timeLocal: string;
  city: string;
  homeSlot: string;
  awaySlot: string;
  /** Grupos posibles del 3º clasificado (ranura visitante). */
  thirdAwayGroups?: string[];
}

export const WC2026_R32_FIXTURES_RAW: R32FixtureRaw[] = [
  {
    num: 73,
...
/** Par R32 → octavos (partidos 89–96). */
export interface R32ToR16Link {
  r32Nums: [number, number];
  r16Num: number;
  side: "left" | "right";
}

export const WC2026_R32_TO_R16: R32ToR16Link[] = [
...
export const WC2026_R16_TO_R8: Array<{ r16Num: number; r8Num: number }> = [
  { r16Num: 89, r8Num: 97 },
  { r16Num: 90, r8Num: 97 },
  { r16Num: 91, r8Num: 99 },
  { r16Num: 92, r8Num: 99 },
...
export function r16LinkForR32(num: number): R32ToR16Link | undefined {
  return WC2026_R32_TO_R16.find((l) => l.r32Nums[0] === num || l.r32Nums[1] === num);
}

export function r8NumForR16(r16Num: number): number | undefined {
  return WC2026_R16_TO_R8.find((l) => l.r16Num === r16Num)?.r8Num;
}

/** Octavos (89–96) → cuartos (97–100). */
export function r4NumForR16(r16Num: number): number | undefined {
