...
const R8_FIXTURES: KnockoutFixture[] = [
  {
    num: 89,
    roundKey: "R8",
...
export const WC2026_KNOCKOUT_FIXTURES: KnockoutFixture[] = [
  ...WC2026_R32_FIXTURES_RAW.map((fx) => ({
    num: fx.num,
    roundKey: "R16" as const,
